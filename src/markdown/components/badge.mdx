...
<Installation component="badge">
  ```tsx file=<rootDir>/src/registry/default/ui/badge.tsx
  ```
</Installation>
...
<ComponentPreview component="badge" example="default">
  ```tsx file=<rootDir>/src/examples/ui/badge/default.tsx
  ```
</ComponentPreview>

### Destructive

<ComponentPreview component="badge" example="destructive">
  ```tsx file=<rootDir>/src/examples/ui/badge/destructive.tsx
  ```
</ComponentPreview>
